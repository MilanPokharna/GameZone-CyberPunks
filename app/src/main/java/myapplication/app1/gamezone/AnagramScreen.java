package myapplication.app1.gamezone;/* Copyright 2016 Google Inc.
 *
...
public class AnagramScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anagram_screen);
